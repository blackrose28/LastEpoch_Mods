...
namespace LastEpoch_Hud.Scripts
{
    ...
    public class Mods_Manager : MonoBehaviour
    {
        ...
        GameObject items_crafting_eternal = null;
        ...
        void Awake()
        {
            ...
            items_crafting_eternal = Object.Instantiate(new GameObject { name = "Mod_Items_Headhunter" }, Vector3.zero, Quaternion.identity);
